...
const STORAGE_KEY = 'adolar_songster_auth';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('adolar-songster:unauthorized', handleUnauthorized);
    return () => window.removeEventListener('adolar-songster:unauthorized', handleUnauthorized);
  }, []);
