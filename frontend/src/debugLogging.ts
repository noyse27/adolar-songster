...
const SESSION_KEY = 'adolar-songster:debug-client-session-id';
const DEVICE_KEY = 'adolar-songster:debug-device-id';
const ENABLED_KEY = 'adolar-songster:debug-enabled';
...
export function describeAudioElement(audio: HTMLAudioElement): Record<string, unknown> {
  return {
