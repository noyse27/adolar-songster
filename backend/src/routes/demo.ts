...
// information. The frontend's demo banner polls this to know whether to
// show itself at all - the same instance's code can run as a normal
// deployment with DEMO_MODE unset, in which case `active` is false and the
